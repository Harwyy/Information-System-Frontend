...
const SpecialOperation = () => {
    ...
    const handleGetMaxOfficialAddress = async () => {
        ...
        try {
            ...
            openModal('maxOfficial', organization, 'Organization with Max Official Address');
    ...
    const handleJoinOrganizations = async () => {
        ...
        try {
            ...
            openModal('joinOrganizations', result, 'Organizations Joined Successfully');
            ...
            case 'maxOfficial':
                return (
                    <div className="modal-content-v2">
                        ...
                        <pre className="result-pre">{JSON.stringify(modal.data, null, 2)}</pre>
                    </div>
                );
            case 'groupFullname':
                return (
    ...
    return (
        <div className="special-operation-page">
            <LoadingIndicator
                loading={loading.updateCount || loading.maxOfficial || loading.groupFullname || loading.joinOrganizations}
            ...
            <div className="special-operations-grid">
                ...
                <div className="operation-card">
                    ...
                    <p>Retrieve the organization with the maximum official address value</p>
                ...
                <div className="operation-card">
                    ...
                    <div className="operation-controls">
                        <div className="select-group">
                            ...
                            <div className="select-wrapper">
                                ...
                                >
                                    ...
                                    {organizations.map(org => (
                                        <option key={org.id} value={org.id} disabled={org.id.toString() === selectedFirstOrg}>
                                            {org.name} (ID: {org.id})
                                        </option>
                                    ))}
                                </select>
                        ...
                        <button
                            ...
                            disabled={loading.joinOrganizations || !selectedFirstOrg || !selectedSecondOrg}
